...
def get_user_rename_preference(user_id):
    # Retrieve the user's custom renaming tag if set, or default to '@The_real_xTaR'
    return user_rename_preferences.get(str(user_id), '@The_real_xTaR')
